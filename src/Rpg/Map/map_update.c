...
static sfVector2f coord_to_px_float(
    sfRenderWindow *wind, sfVector2f pos, map_t *map)
{
...
void move_view_to_player(map_t *map, float dt)
{
    ...
    sfVector2f local_player_pos =
        coord_to_px_float(map->rpg->wind, player_pos, map);
